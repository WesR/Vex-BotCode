...
void setLeftMotors(int _speed){ //Move left motors
	setMotor(leftMotor,_speed);
	setMotor(leftMotor2,_speed);
}

void setRightMotors(int _speed){ //Move right motors
	setMotor(rightMotor,_speed);
	setMotor(rightMotor2,_speed);
}

void stopLeftMotors(void){ //Stop left motors
	stopMotor(leftMotor);
	stopMotor(leftMotor2);
}
void stopRightMotors(void){ //Stop right motors
