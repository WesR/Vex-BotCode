...
#pragma config(Motor,  port4,           sweepMotor,    tmotorVex393_MC29, openLoop)
...
void manualControl(void){ //For manual control
	...
	if (vexRT(Btn7L)){if(!sweeping_on){sweeping_on = true; setMotor(sweepMotor,65);}else{sweeping_on = false;stopMotor(sweepMotor);}} // Starts and stops the sweaper
